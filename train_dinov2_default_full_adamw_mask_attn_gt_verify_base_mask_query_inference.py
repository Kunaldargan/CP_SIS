...
from surgical_dinov2_mask_query_guidance import SurgicalDINOCLassifier
import tqdm
...
batch_size = 64 #256 #160 #64 #512 #8
...
if "18" in dataset_name:
    ...
    num_epochs = 50 #35
    lr = 0.001
    save_dir = "/home/sit/msr/siy207566/scratch/v03/test/SurgicalSAM/Surgical_Mask_Classifier_Mask_Attn/work_dirs/dinov2_LQ_LORA_ev18_default_adamw_Base_All_Blocks/"
...
if args.checkpoint:
    checkpoint_path  = log_file = osp.join(save_dir, 'checkpoint_epoch_34.pth') ##"checkpoint_epoch_336.pth") #
